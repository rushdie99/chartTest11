...
public class ScatterChart extends XYChart {
 ...
 RadialGradient mRadialGradient = new RadialGradient(x,y,2*size,new int[] {
      Color.WHITE, Color.WHITE, Color.WHITE, paint.getColor() }, null, Shader.TileMode.CLAMP);

   // RadialGradient mRadialGradient = new RadialGradient(x,y,2*size,Color.WHITE,Color.BLACK, Shader.TileMode.MIRROR);

    paint.setShader(mRadialGradient);
    canvas.drawCircle(x, y,2* size, paint);
